...
func createTicketWithTx(ctx context.Context, db *sql.DB, createdByUser int, ticketName string, authorities []*dto.UserAuthorityReq, useableCount int) (string, error) {
