...
type ticketR struct {
	TicketRole *TicketRole `boil:"TicketRole" json:"TicketRole" toml:"TicketRole" yaml:"TicketRole"`
}
...
func (r *ticketR) GetTicketRole() *TicketRole {
	if r == nil {
		return nil
	}
	return r.TicketRole
...
// TicketRole pointed to by the foreign key.
func (o *Ticket) TicketRole(mods ...qm.QueryMod) ticketRoleQuery {
...
// LoadTicketRole allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-1 relationship.
func (ticketL) LoadTicketRole(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTicket interface{}, mods queries.Applicator) error {
	var slice []*Ticket
	var object *Ticket
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load TicketRole")
	}

	var resultSlice []*TicketRole
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice TicketRole")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for ticket_role")
	}
...
// SetTicketRole of the ticket to the related item.
// Sets o.R.TicketRole to related.
// Adds o to related.R.Ticket.
func (o *Ticket) SetTicketRole(ctx context.Context, exec boil.ContextExecutor, insert bool, related *TicketRole) error {
	var err error

	if insert {
		related.TicketID = o.TicketID
		...
		values := []interface{}{o.TicketID, related.TicketID}
	...
	if o.R == nil {
		...
		o.R.TicketRole = related
	}

	if related.R == nil {
		related.R = &ticketRoleR{
			Ticket: o,
		}
	} else {
		related.R.Ticket = o
