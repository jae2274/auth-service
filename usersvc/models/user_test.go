...
var (
	userDBTypes = map[string]string{`UserID`: `int`, `Name`: `varchar`, `AuthorizedBy`: `enum('GOOGLE')`, `AuthorizedID`: `varchar`, `Email`: `varchar`, `AgreeMail`: `tinyint`, `CreateDate`: `datetime`}
	_           = bytes.MinRead
)
